...
namespace UkTote
{
    public partial class ToteGateway
    {
        public Task<RacecardReply> GetRacecardFast(DateTime forDate, bool includePools)
        {
            ...
            {
                if (racecard?.Meetings == null) return;
                ...
                if (!racecard.Meetings[reply.MeetingNumber].MeetingPools?.ContainsKey(reply.MeetingPoolNumber)??false)
                {
